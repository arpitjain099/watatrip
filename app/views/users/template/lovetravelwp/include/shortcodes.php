...
function shortcode_travelid($atts, $content = null)
{
	...
	$str ='
		...
		<div class="btnsarchivesingletravel">'.do_shortcode($lovetravel_btnoffer_travel).'</div>'.get_the_post_thumbnail($idtravel).'</div>
		</a>
		<div class="pricetitleleftarchivetour">
...
function shortcode_buildsearchform($atts, $content = null)
{
	...
	$str = '<form class="'.$atts['color'].'" id="formsearchtravel"  method="post" action="'.$atts['action'].'"><div class="labelsearchtravel"><i class="icon-direction"></i><p>BOOK TRAVELS</p></div>';
	...
	$str .= '<div class="grid_2"><input value="search" type="submit"/></div></form>';
