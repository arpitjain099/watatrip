	...
	<div class="archivesinglepost
		...
		<div class="infoarchivesinglepost">
			...
			<div class="iconarchivesinglepost">
				...
				<a title="<?php comments_number( 'No Comments', '1 Comments', '% Comments' ); ?>" class="tooltip" href="<?php the_permalink(); ?>"><i class="icon-comment"></i></a>
			</div>
		...
		<a class="btn" href="<?php the_permalink(); ?>"><p>READ MORE</p></a> 
