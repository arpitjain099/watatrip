...
$of_options[] = array( 	"name" 		=> "Intro effect",
						"desc" 		=> "Choose the intro effect",
						"id" 		=> "header_logointroeffect",
						"std" 		=> "fade-up",
						"type" 		=> "select",
						"options" 	=> $of_options_introeffecttype
				);
				
$of_options[] = array( 	"name" 		=> "Intro effect time",
						"desc" 		=> "Choose the intro effect timing",
						"id" 		=> "header_logointroeffecttime",
						"std" 		=> "animate4",
						"type" 		=> "select",
						"options" 	=> $of_options_introeffecttime
				);
...
$of_options[] = array( 	"name" 		=> "Navigation Position Fixed",
						"desc" 		=> "Enable position fixed for your manu navigation (sticky)",
						"id" 		=> "header_navigationpositionfixed",
						"std" 		=> 1,
						"type" 		=> "switch"
);
...
$of_options[] = array( 	"name" 		=> "Intro effect",
						"desc" 		=> "Choose the intro effect",
						"id" 		=> "header_navigationintroeffect",
						"std" 		=> "fade-down",
						"type" 		=> "select",
						"options" 	=> $of_options_introeffecttype
				);
...
$of_options[] = array( 	"name" 		=> "Intro effect time",
						"desc" 		=> "Choose the intro effect timing",
						"id" 		=> "header_navigationintroeffecttime",
						"std" 		=> "animate1",
						"type" 		=> "select",
						"options" 	=> $of_options_introeffecttime
				);
...
$of_options[] = array( 	"name" 		=> "Copyright Text<br><img src=\"http://www.ten28.com/yt.jpg\">",
