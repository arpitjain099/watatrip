	...
	<div class="allheader">
		...
		<?php if($smof_data['header_topnavigation'] == 1): ?>
			...
			<div class="topnavigationmenu">
				<div class="container">
					<div class="grid_6">
						<p><?php echo do_shortcode($smof_data['header_leftcontenttopnavigation']); ?></p>
					</div>
					<div class="grid_6" style="text-align:right">
						<p><?php echo do_shortcode($smof_data['header_rightcontenttopnavigation']); ?></p>
					</div>
				</div>
			</div>
		...
		<!--start header-->
		<header id="navigationmenu" class="<?php if ($smof_data['header_navigationintroeffect'] == "none") {} else { ?><?php echo $smof_data['header_navigationintroeffect']; ?> <?php echo $smof_data['header_navigationintroeffecttime']; ?><?php } ?> navigationmenu<?php if ($smof_data['header_darknavigation'] == 0): echo "light"; else: echo "dark"; endif ?>">
			...
			<div class="container">
				...
				<div class="grid_12 gridnavigation">
					...
					<?php if($smof_data['header_logo']): ?>
						<a href="<?php echo home_url(); ?>"><img <?php if($smof_data['header_logowidth']): echo "style=\"width:".$smof_data['header_logowidth']."px\""; endif; ?> class="logo <?php if ($smof_data['header_logointroeffect'] == "none") {} else { ?><?php echo $smof_data['header_logointroeffect']; ?> <?php echo $smof_data['header_logointroeffecttime']; ?><?php } ?>" alt="" src="<?php echo $smof_data['header_logo']; ?>"></a>	
					<?php else: ?>
						<a href="<?php echo home_url(); ?>"><img <?php if($smof_data['header_logowidth']): echo "style=\"width:".$smof_data['header_logowidth']."px\""; endif; ?> class="logo <?php echo $smof_data['header_coloriconrightsearch']; ?>" alt="" src="<?php echo get_template_directory_uri(); ?>/img/logo.png"></a>
					<?php endif; ?>
