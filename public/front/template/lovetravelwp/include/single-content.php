			...
			<div class="singlepost
				...
				<div class="infosinglepost">
					...
					<div class="iconsinglepost">
						...
						<p><i class="icon-comment"></i><a class="internal-link" href="#startsinglecomments"><?php comments_number( 'No Comments', '1 Comments', '% Comments' ); ?></a></p>
					</div>
				...
				<div class="pagecontent">
					...
					<?php if (isset($smof_data['single_categorylist'])) { ?>
						<?php if ($smof_data['single_categorylist'] == 1): ?>
							<p class="singlecategorylist">Category: <?php the_category(", ");?></p>
						<?php endif; ?>
					<?php }else{ ?>
						<p class="singlecategorylist">Category: <?php the_category(", ");?></p>
					<?php } ?>
