...
<section id="internalpage">
	...
	<div class="container clearfix">
        ...
        <div class="grid_12" style="text-align:center">
			<h1><?php echo $smof_data['pages_notfoundsearchtitle']; ?></h1><i style="font-size:35px; display:inline-block; margin-top:20px; color:#5e6d81;" class="<?php echo $smof_data['pages_notfoundsearchicon']; ?>"></i>
        </div>
        <!--end content-->
