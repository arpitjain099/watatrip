            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <!-- Start Logo / Text -->
                        <a class="navbar-brand text-logo" href="#"><i class="ion ion-paper-airplane"></i>WATaTRIP</a>
                        <!-- End Logo / Text icon-rocket blue-->
                    </div>
                    <!-- Start Navigation -->
                    <div class="navigation navbar-collapse collapse">
                        <ul class="nav navbar-nav menu-right">
                            <li class="active"><a href="#banner">Home</a></li>
                            <li><a href="/laravel1/#hiw">How it Works</a></li>
                            <li><a href="/laravel1/#faq">FAQs</a></li>
                            <li><a href="/laravel1/#contact">Contact Us</a></li>
